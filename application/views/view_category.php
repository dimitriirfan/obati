	...
	<div class="card-deck">
		...
		<div class="card shadow-sm">
			<div class="card-body" onclick="toVitamin()">
				...
				<a href="<?php echo base_url("catalog/batuk_flu")?>" class="stretched-link"></a>
		...
		<div class="card shadow-sm ">
			<div class="card-body" onclick="toVitamin()">
				...
				<a href="<?php echo base_url("catalog/antibiotik")?>" class="stretched-link"></a>
		...
		<div class="card shadow-sm">
			<div class="card-body" onclick="toVitamin()">
				...
				<a href="<?php echo base_url("catalog/kontrasepsi_hormon")?>" class="stretched-link"></a>
