...
<head>
	...
	<!-- style -->
	<link rel="stylesheet" href="<?php echo base_url("./assets/css/article/articledetail.css")?>">
	<link href="<?php echo base_url ("./assets/css/article/owl.carousel.css") ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo base_url ("./assets/css/article/owl.theme.default.css") ?>" rel="stylesheet" type="text/css"/>
	<link href="<?php echo base_url ("./assets/css/article/media_query.css") ?>" rel="stylesheet" type="text/css"/>
	<link href="<?php echo base_url ("./assets/css/article/animate.css") ?>" rel="stylesheet" type="text/css"/>
...
<div class="slogan">
    <div class="news-detail">
        ...
        <div><a href="<?php echo base_url('index.php/Controller_articledetail') ?>" class="fh5co_good_font">Lorem lorem lorem lorem lorem lorem Tips and trick to get <br> killed by COVID-19 rapidly.</a></div>
    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullabr
                                malesuada enim id enim congue convallis. Praesent a cursus orci. 
                                Proin mauris eros, rhoncus in risus nec, vestibulum dignissim
                                diam. Duis dapibus, magna ac fringilla consectetur, tellus quam 
                                aliquam quam, molestie tincidunt justo risus et nunc. Donec quis 
                                justo nec diam hendrerit facilisis placerat non magna. Class aptent
