					...
					<form action="<?php echo base_url("Register/register")?>" method="post">
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input class="form-control <?php if (form_error('name')) { echo 'is-invalid';} ?>" type="text" id="input_name" name="name" value="<?= set_value('name')?>"
							...
							<div class="form-group col-md-6">
								...
								<input class="form-control <?php if (form_error('email')) { echo 'is-invalid';} ?> <?php if (form_error('name')) { echo 'is-invalid';} ?>" type="email" id="input_email" name="email" value="<?= set_value('email')?>"
						...
						<div class="form-group">
							...
							<input class="form-control <?php if (form_error('address')) { echo 'is-invalid';} ?>" type="text" id="input_address" name="address" value="<?= set_value('address')?>"
								placeholder="Please enter your address">
							<?= form_error('address', '<small class="text-danger">', '</small>')?>
						</div>
						<div class="form-group">
							<label for="inputPlaceandBirhdate">Birth date</label>
							<input class="form-control <?php if (form_error('birth')) { echo 'is-invalid';} ?>" type="date" id="input_birth" name="birth" value="<?= set_value('birth')?>"
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input class="form-control <?php if (form_error('password')) { echo 'is-invalid';} ?>" type="password" id="input_password" name="password"
							...
							<div class="form-group col-md-6">
								...
								<input class="form-control <?php if (form_error('confirm')) { echo 'is-invalid';} ?>" type="password" id="input_confirm" name="confirm"
