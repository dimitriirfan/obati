        ...
        <div class="col-md-6 col-12 paddding animate-box" data-animate-effect="fadeIn">
            <div class="fh5co_suceefh5co_height"><img src="<?php echo base_url("assets/img/boy1.jpg")?>" alt="img"/>
                ...
                <div class="fh5co_suceefh5co_height_position_absolute_font">
                    ...
                    <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;1 April, 2020
                    </a></div>
                    <div class=""><a href="<?php echo base_url('index.php/Controller_articledetail') ?>" class="fh5co_good_font">Tips and trick to get <br> killed by COVID-19 rapidly.</a></div>
                    <h1 class="by">By : Pororo-kun</h1>
                    <h2 class="article-desc"> Lorem Ipsum is simply dummy text of the printing and typesetting industry.<br> Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</h1>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="<?php echo base_url("assets/img/boy1.jpg")?>" alt="img"/>
                        <div class="fh5co_suceefh5co_height_position_absolute"></div>
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;Oct
                                28,2017 </a></div>
                            <div class=""><a href="single.html" class="fh5co_good_font_2">Tips and trick to get  <br> killed by COVID-19 rapidly. </a></div>
                            <h1 class="by-small">By : Pororo-kun</h1>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="<?php echo base_url("assets/img/boy1.jpg")?>" alt="img"/>
                        ...
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            ...
                            <div class=""><a href="single.html" class="fh5co_good_font_2"> Tips and trick to get killed by... </a></div>
                            <h1 class="by-small">By : Pororo-kun</h1>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="<?php echo base_url("assets/img/boy1.jpg")?>" alt="img"/>
                        ...
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;Oct
                                28,2017 </a></div>
                            <div class=""><a href="single.html" class="fh5co_good_font_2"> Tips and trick to get killed by COVID-19 rapidly. </a></div>
                            <h1 class="by-small">By : Pororo-kun</h1>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="<?php echo base_url("assets/img/boy1.jpg")?>" alt="img"/>
                        ...
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;Oct
                                28,2017 </a></div>
                            <div class=""><a href="single.html" class="fh5co_good_font_2"> Tips and trick to get killed... </a></div>
                            <h1 class="by-small">By : Pororo-kun</h1>
                        </div>
                    </div>
                </div>
            ...
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    ...
                    <div class="fh5co_latest_trading_img_position_absolute_1">
                        ...
                        <div class="fh5co_latest_trading_date_and_name_color"> Pororo-kun : 4 April, 2020 </div>
                    </div>
                </div>
            </div>
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    <div class="fh5co_latest_trading_img"><img src="<?php echo base_url("assets/img/boy1.jpg")?>" alt="" class="fh5co_img_special_relative"/></div>
                    <div class="fh5co_latest_trading_img_position_absolute"></div>
                    <div class="fh5co_latest_trading_img_position_absolute_1">
                        <a href="single.html" class="text-white"> Here's a new way to take better photos for instagram </a>
                        <div class="fh5co_latest_trading_date_and_name_color"> Pororo-kun : 4 April, 2020</div>
    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                    <div class="fh5co_news_img"><img src="<?php echo base_url("assets/img/boy1.jpg")?>" alt=""/></div>
                            <div></div>
                    </div>
                    <div class="col-md-7 animate-box">
                        <a href="single.html" class="fh5co_magna py-2"> Magna aliqua ut enim ad minim veniam quis
                        nostrud quis xercitation ullamco. </a> <a href="single.html" class="fh5co_mini_time py-3"> Pororo -
                        April 03,2020 </a>
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_suceefh5co_height_3"><img src="<?php echo base_url("assets/img/boy1.jpg")?>" alt=""/></div>
                            <div></div>
                        </div>
                    </div>
                    <div class="col-md-7">
                        <a href="single.html" class="fh5co_magna py-2"> Magna aliqua ut enim ad minim veniam quis
                        nostrud quis xercitation ullamco. </a> <a href="#" class="fh5co_mini_time py-3"> Pororo -
                        April 03,2020 </a>
                    ...
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img">
                                <img src="<?php echo base_url("assets/img/boy1.jpg")?>" alt=""/>
                            </div>
                            <div></div>
                        </div>
                    </div>
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center"><img src="<?php echo base_url("assets/img/boy1.jpg")?>" alt="img"
